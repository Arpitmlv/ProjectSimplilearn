...
public class Project1 {
	...
	public static void main(String[] args) {
		...
		char ch;
		File directory = new 
		File("C:\\Users\\91831\\OneDrive\\Desktop\\File Coation");
		...
		System.out.println("*****************************************");
		System.out.println("******* ARPIT MALVIYA ******************");
		System.out.println("*****************************************");
		...
		do {
			...
			File file = new 
			File("C:\\Users\\91831\\OneDrive\\Desktop\\File Coation\\" + filename + ".txt");
			...
			File file = new File("C:\\Users\\91831\\OneDrive\\Desktop\\File Coation//" + delete_filename);
			if (file.delete()) {
